<div class="col">
    <div class="card shadow-sm product-card" style="height: 100%; width: 100%; @unless($product->isExists) filter: grayscale(1); color: lightgray; @endunless">
        @if ($product->weekly_discount)
            <span class="product-discount-label">-{{$product->weekly_discount->discount}}%</span>
        @endif
